            ...
            const unsigned char *pub_seed, uint32_t addr[8])
{
	...
	//if(addr_as_bytes[15]==0x02 && addr_as_bytes[23]==0x07 ){	
	//printf("layer in 6:");
	...
	//if(addr_as_bytes[15]==0x02){	
	//printf("bitmask1");
	//	for (unsigned int j = 0; j < params->n; j++)
      	//		printf("%02x", bitmask[j]);
      	//	printf("\n\n");  	
      	//}
    ...
    //if(addr_as_bytes[15]==0x02 && addr_as_bytes[23]==0x05  ){	
	//printf("buf 5:");
	//	for (unsigned int j = 0; j < 3*params->n; j++)
      	//		printf("%02x", in[j]);
      	//	printf("\n\n");
      	//printf("addr");
	//	for (unsigned int j = 0; j < params->n; j++)
