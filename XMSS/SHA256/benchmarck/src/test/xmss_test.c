...
int main()
{
    ...
    printf("Public Key: ");
    //f05ed853334bef102ae70a4810e6329a4902ec605f2ef1d8f37b02011bccf825
    //8e91100e6f44666f950b93f68c2db457158f3cde39333e2768c53770230ea2b3
    for (unsigned int j = 0; j < XMSS_OID_LEN + params.pk_bytes; j++)
      printf("%02x", pk[j]);
   
    printf("secret Key: ");
    //2072a1a266f236c93b46dfa9ce868e792981d0d0a047817446cb7c58698fd233
    for (unsigned int j = 0; j < XMSS_OID_LEN + params.sk_bytes; j++)
      printf("%02x", sk[j]);
