...
void thash_h_3(input_stream<uint32> * __restrict data, input_stream<uint32> * __restrict addr, 
                /*unsigned char (&Pubseed)[32],*/ output_stream<uint32>* __restrict dout1, output_stream<uint32>* __restrict dout2)
{
    
    int wots_pk_num =0;
    while(wots_pk_num <9){ // totally 9 cahin in a leaf
    ...
    //accept the stream
        ...
        temp_addr[5]=0x00000003; //address height = 3 in the first layer   
