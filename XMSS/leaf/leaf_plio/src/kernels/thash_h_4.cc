...
void thash_h_4(input_stream<uint32> * __restrict data, input_stream<uint32> * __restrict addr, 
                /*unsigned char (&Pubseed)[32],*/ output_stream<uint32>* __restrict dout1, output_stream<uint32>* __restrict dout2)
{
    
    int wots_pk_num =0;
    while(wots_pk_num <5){ // totally 5 cahin in a leaf
    ...
    //accept the stream
        ...
        temp_addr[5]=0x00000004; //address height = 4 in the first layer   
    ...
    //output the stream
        ...
        temp_addr[7]=0x000000002;  //pad || pub_seed || mask1
