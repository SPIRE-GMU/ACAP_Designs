...
void thash_h_1(input_stream<uint32> * __restrict data, input_stream<uint32> * __restrict addr, 
                /*unsigned char (&Pubseed)[32],*/ output_stream<uint32>* __restrict dout1, output_stream<uint32>* __restrict dout2)
{
    
    int wots_pk_num =0;
    while(wots_pk_num <34){ // totally 67 cahin in a leaf
    ...
    //accept the stream
        ...
        temp_addr[5]=0x01000000; //address height = 1 in the second layer   
