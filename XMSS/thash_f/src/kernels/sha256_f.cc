...
void sha256_f(input_stream<uint32> * __restrict prf_in, input_stream<uint32> * __restrict mask_in,  output_stream<uint32>* __restrict dout, output_stream<uint32>* __restrict addr_out)
{
   ...
   //aie::tile tile=aie::tile::current();   //using tile.cycles if you want to print cycles
   //unsigned long long time1=tile.cycles();
    ...
    memset(buf + len,0,append); //zero,it is recommended to replace with inbuilt function
    ...
    /******************************************************************/
    //above accree pand ace input data 
    /******************************************************************/
    //following process hash function, compress and write out
    /******************************************************************/
    uint32_t w[64];
    uint32_t temp_w[2];
   
    size_t chunk_len = new_len / 64; //divided into 512-bit chunk
