...
for.end:                                          ; preds = %for.body
  ...
  %call10 = call addrspace(1) %"class.aie::vector" @_ZNK3aie5accumI5acc64Lj8EE9to_vectorIiEENS_6vectorIT_Lj8EEEi(%"class.aie::accum"* nonnull align 32 dereferenceable(128) %temp0, i32 31) #28, !dbg !1546, !noalias !1502
...
entry:
  ...
  call addrspace(1) void @llvm.dbg.value(metadata i32 31, metadata !1605, metadata !DIExpression()), !dbg !1606
  %0 = bitcast %"class.aie::accum"* %this to %"class.aie::detail::accum_base"*, !dbg !1607
  %call = call addrspace(1) %"class.aie::vector" @_ZNK3aie6detail10accum_baseILNS0_10AccumClassE0ELj64ELj8EE9to_vectorIiEENS_6vectorIT_Lj8EEEi(%"class.aie::detail::accum_base"* nonnull align 32 dereferenceable(128) %0, i32 31) #28, !dbg !1607
...
entry:
  ...
  call addrspace(1) void @llvm.dbg.value(metadata i32 31, metadata !1930, metadata !DIExpression()), !dbg !1938
  ...
  %call = call addrspace(1) %struct.v8int32 @_ZZN3aie6detail10accum_baseILNS0_10AccumClassE0ELj64ELj8EE7get_srsIiEEDavENKUlRKT_iE_clI7v8acc80EEDaS7_i(%class.anon* nonnull align 1 dereferenceable(1) %fn, %struct.v8acc80* nonnull align 32 dereferenceable(128) %data, i32 31) #28, !dbg !1945
...
entry:
  ...
  call addrspace(1) void @llvm.dbg.value(metadata i32 31, metadata !1960, metadata !DIExpression()), !dbg !1961
  %0 = load %struct.v8acc80, %struct.v8acc80* %acc, align 32, !dbg !1962, !tbaa !1963
  %call = call addrspace(1) %struct.v8int32 @_Z3srs7v8acc80i(%struct.v8acc80 %0, i32 31) #34, !dbg !1962
...
entry:
  ...
  store i32 31, i32* %shft.addr, align 4, !tbaa !1663
...
while.body2:                                      ; preds = %while.body2, %while.body2.lr.ph
  ...
  %proc_26_0_bounds.02 = phi i32 [ %6, %while.body2.lr.ph ], [ %spec.select, %while.body2 ]
  call addrspace(1) void @llvm.dbg.value(metadata i32 %index.13, metadata !3397, metadata !DIExpression()), !dbg !3418
  call addrspace(1) void @llvm.dbg.value(metadata i32 %proc_26_0_bounds.02, metadata !3398, metadata !DIExpression()), !dbg !3421
  ...
  %cmp = icmp sgt i32 %proc_26_0_bounds.02, 0, !dbg !3429
  %dec = add nsw i32 %proc_26_0_bounds.02, -1
  %spec.select = select i1 %cmp, i32 %dec, i32 %proc_26_0_bounds.02, !dbg !3431
...
!3398 = !DILocalVariable(name: "proc_26_0_bounds", scope: !3399, file: !264, line: 29, type: !1636)
