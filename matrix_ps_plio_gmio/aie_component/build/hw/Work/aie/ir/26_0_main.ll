; ModuleID = '/home/yzwu/Desktop/soc_test/aie_component/build/hw/Work/aie/26_0/src/26_0.cc'
source_filename = "/home/yzwu/Desktop/soc_test/aie_component/build/hw/Work/aie/26_0/src/26_0.cc"
...
while.body:                                       ; preds = %while.cond
  store i32 undef, i32* %proc_26_0_bounds, align 4, !dbg !311, !noalias !286
  %7 = bitcast i32* %proc_26_0_bounds to i8*, !dbg !311
  call addrspace(1) void @llvm.lifetime.start.p0i8(i64 4, i8* %7) #13, !dbg !311, !noalias !286
  call addrspace(1) void @llvm.dbg.declare(metadata i32* %proc_26_0_bounds, metadata !284, metadata !DIExpression()), !dbg !312
  ...
  store i32 %8, i32* %proc_26_0_bounds, align 4, !dbg !312, !tbaa !292, !noalias !286
  br label %while.cond1, !dbg !314

while.cond1:                                      ; preds = %if.end, %while.body
  %9 = load i32, i32* %proc_26_0_bounds, align 4, !dbg !315, !tbaa !292, !noalias !286
...
while.body2:                                      ; preds = %while.cond1
  ...
  %11 = load i32, i32* %proc_26_0_bounds, align 4, !dbg !322, !tbaa !292, !noalias !286
  %cmp = icmp sgt i32 %11, 0, !dbg !324
  br i1 %cmp, label %if.then, label %if.end, !dbg !325

if.then:                                          ; preds = %while.body2
  %12 = load i32, i32* %proc_26_0_bounds, align 4, !dbg !326, !tbaa !292, !noalias !286
  %dec = add nsw i32 %12, -1, !dbg !326
  store i32 %dec, i32* %proc_26_0_bounds, align 4, !dbg !326, !tbaa !292, !noalias !286
...
cleanup:                                          ; preds = %if.end5, %if.then4
  %14 = bitcast i32* %proc_26_0_bounds to i8*, !dbg !336
...
entry:
  ...
  %0 = load %struct.ipd.custom_type.uint2_t.uint2_t, %struct.ipd.custom_type.uint2_t.uint2_t* %custom_type.tmp, align 4, !tbaa !362
  store %struct.ipd.custom_type.uint2_t.uint2_t %0, %struct.ipd.custom_type.uint2_t.uint2_t* %agg.tmp, align 4, !tbaa !362
  %1 = load %struct.ipd.custom_type.uint2_t.uint2_t, %struct.ipd.custom_type.uint2_t.uint2_t* %agg.tmp, align 4, !tbaa !362
...
entry:
  ...
  %0 = load %struct.ipd.custom_type.uint2_t.uint2_t, %struct.ipd.custom_type.uint2_t.uint2_t* %a0, align 4, !tbaa !362
...
!284 = !DILocalVariable(name: "proc_26_0_bounds", scope: !285, file: !264, line: 29, type: !282)
...
!357 = !DISubprogram(name: "matrix256", linkageName: "_Z9matrix256P12input_streamIiES1_P13output_streamIiE", scope: !264, file: !264, line: 16, type: !358, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !361)
!358 = !DISubroutineType(types: !359)
!359 = !{null, !360, !360, !353}
!360 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !343)
!361 = !{}
!362 = !{!363, !363, i64 0, i64 4}
!363 = !{!294, i64 4, !"uint2_t"}
