...
/************************** Functions/APIs *****************************/
  ...
  bool mygraph_load_elf(const std::string& work_path, std::vector<std::string>& elfInfoPath)
  {
	...
	std::string work_dir = (work_path.empty() ?  "/home/yzwu/Desktop/soc_test/aie_component/build/hw/./Work" : work_path);
  ...
  void mygraph_init(const std::string& work_path)
  {
	...
	std::string work_dir = (work_path.empty() ?  "/home/yzwu/Desktop/soc_test/aie_component/build/hw/./Work" : work_path);
	// S_AIE_OUT_ch0_C26_R0 M_SOUTH_ch3_C26_R0 net2

	XAie_StrmConnCctEnable(&DevInst, XAie_TileLoc(26, 1), CORE, 0, SOUTH, 3);

	// S_SHIM_NORTH_ch3_C26 M_SHIM_SOUTH_ch2_C26 net2

	XAie_StrmConnCctEnable(&DevInst, XAie_TileLoc(26, 0), NORTH, 3, SOUTH, 2);

	// S_SHIM_SOUTH_ch3_C26 M_SHIM_NORTH_ch4_C26 net0

	XAie_StrmConnCctEnable(&DevInst, XAie_TileLoc(26, 0), SOUTH, 3, NORTH, 4);

	// S_SHIM_SOUTH_ch7_C26 M_SHIM_NORTH_ch5_C26 net1

	XAie_StrmConnCctEnable(&DevInst, XAie_TileLoc(26, 0), SOUTH, 7, NORTH, 5);

	// S_SOUTH_ch4_C26_R0 M_AIE_IN_ch0_C26_R0 net0

	XAie_StrmConnCctEnable(&DevInst, XAie_TileLoc(26, 1), SOUTH, 4, CORE, 0);

	// S_SOUTH_ch5_C26_R0 M_AIE_IN_ch1_C26_R0 net1

	XAie_StrmConnCctEnable(&DevInst, XAie_TileLoc(26, 1), SOUTH, 5, CORE, 1);
	...
	XAie_EnableShimDmaToAieStrmPort(&DevInst, XAie_TileLoc(26, 0), 3);
	//Connect mux stream id 7 to shim DMA. 
	XAie_EnableShimDmaToAieStrmPort(&DevInst, XAie_TileLoc(26, 0), 7);
	//Connect demux stream id 2 to shim DMA. 
	XAie_EnableAieToShimDmaStrmPort(&DevInst, XAie_TileLoc(26, 0), 2);
...
/************************** Clock gating *****************************/
  ...
  {
    XAie_LocType locs[3] = {XAie_TileLoc(25, 1), XAie_TileLoc(26, 1), XAie_TileLoc(26, 0), };
...
/************************** Graph Configurations  *****************************/
  ...
  //{id, name, graphLoadElfFunc, graphInitFunc, graphDebugHalt, coreColumns, coreRows, iterMemColumns, iterMemRows, iterMemAddrs, triggered, plKernelInstanceNames, plAxiLiteModes, plDriverStartFuncs, plDriverCheckIPDoneFuncs}
    {0, "mygraph", &mygraph_load_elf, &mygraph_init, &mygraph_core_debug_halt, {26}, {0}, {25}, {0}, {0x4}, {0}, {}, {}, {}, {},  }, 
  };
  ...
  public:
    InitializeAIEControl()
    {
      ...
      adf::initializeConfigurations(&DevInst, XAIE_NUM_COLS, XAIE_AIE_TILE_NUM_ROWS, XAIE_MEM_TILE_NUM_ROWS,
                                        ...
                                        ess_debug, exclude_pl_control, true, &broadcastConfigForCoreEnable, true, 3);
