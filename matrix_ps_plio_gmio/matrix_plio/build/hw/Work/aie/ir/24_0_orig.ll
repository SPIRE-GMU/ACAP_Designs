...
for.end:                                          ; preds = %for.cond.cleanup
  ...
  %call10 = call addrspace(1) %"class.aie::vector" @_ZNK3aie5accumI5acc64Lj8EE9to_vectorIiEENS_6vectorIT_Lj8EEEi(%"class.aie::accum"* nonnull align 32 dereferenceable(128) %temp0, i32 0) #28, !dbg !1554, !noalias !1502
...
while.body:                                       ; preds = %while.cond
  store i32 undef, i32* %proc_24_0_bounds, align 4, !dbg !3636, !noalias !3615
  %7 = bitcast i32* %proc_24_0_bounds to i8*, !dbg !3636
  call addrspace(1) void @llvm.lifetime.start.p0i8(i64 4, i8* %7) #27, !dbg !3636, !noalias !3615
  call addrspace(1) void @llvm.dbg.declare(metadata i32* %proc_24_0_bounds, metadata !3613, metadata !DIExpression()), !dbg !3637
  ...
  store i32 %8, i32* %proc_24_0_bounds, align 4, !dbg !3637, !tbaa !1532, !noalias !3615
  br label %while.cond1, !dbg !3639

while.cond1:                                      ; preds = %if.end, %while.body
  %9 = load i32, i32* %proc_24_0_bounds, align 4, !dbg !3640, !tbaa !1532, !noalias !3615
...
while.body2:                                      ; preds = %while.cond1
  ...
  %11 = load i32, i32* %proc_24_0_bounds, align 4, !dbg !3647, !tbaa !1532, !noalias !3615
  %cmp = icmp sgt i32 %11, 0, !dbg !3649
  br i1 %cmp, label %if.then, label %if.end, !dbg !3650

if.then:                                          ; preds = %while.body2
  %12 = load i32, i32* %proc_24_0_bounds, align 4, !dbg !3651, !tbaa !1532, !noalias !3615
  %dec = add nsw i32 %12, -1, !dbg !3651
  store i32 %dec, i32* %proc_24_0_bounds, align 4, !dbg !3651, !tbaa !1532, !noalias !3615
...
cleanup:                                          ; preds = %if.end5, %if.then4
  %14 = bitcast i32* %proc_24_0_bounds to i8*, !dbg !3660
...
!3613 = !DILocalVariable(name: "proc_24_0_bounds", scope: !3614, file: !264, line: 29, type: !1659)
